module PostDecorator
  ...
  def post_viewing
    case post_type
    when 'article'
      render partial: 'shared/article', locals: { post: self }
    when 'embed'
      case embed.embed_type
      when 'twitter'
        render partial: 'shared/twitter', locals: { post: self }
      when 'instagram'
        render partial: 'shared/instagram', locals: { post: self }
      when 'fb'
        render partial: 'shared/facebook', locals: { post: self }
      end
    end
  end
  ...
  def box_header_icon
    if article?
      ...
      case embed.embed_type
      when 'twitter'
        '<svg class="w-5 h-5 fill-current" width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      when 'fb'
        '<svg class="w-5 h-5 fill-current mr-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
